...
{
    public partial class _3x5 : Form
    {
        int dakika = 2, saniye = 60,puan=0;
        Image[] resim =
        {
            Properties.Resources.doktor,
            Properties.Resources.polis,
            Properties.Resources.öğretmen,
            Properties.Resources.veteriner,
            Properties.Resources.dedektif,
            Properties.Resources.bahcivan,
            Properties.Resources.itfaiyeci,
            Properties.Resources.asci
        };
        int[] indeks =
        {
        ...
        private void _3x5_Load(object sender, EventArgs e)
        {
            resimKaristir();
            timer1.Start();
        }
